...
**当前处于早期开发阶段 (v0.1.x),API 和功能可能会发生变化**

✅ **已完成** (v0.1.0):
- 核心分镜脚本生成
- 制作包生成 (人物和场景设定表)
- 三种生成模式 (Express/Coach/Hybrid)
...
```bash
# 交互式选择 AI 助手、工作区、生成模式
storyboardify init "我的分镜项目"
...
- **v1.3.0** (2-3周) - 专业优化工具
  ...
  - 镜头优化建议引擎
  - 成本预估计算器
  - `/validate-storyboard` 和 `/optimize-shots` 命令
...
> 📖 **详细规划**: 查看 [OPTIMIZATION_ROADMAP.md](./docs/OPTIMIZATION_ROADMAP.md)
